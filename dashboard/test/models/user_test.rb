...
class UserTest < ActiveSupport::TestCase
  ...
  test 'track_level_progress_sync calls track_proficiency if new perfect score' do
    ...
    User.track_level_progress_sync(student.id, script_level.script_id, script_level.level_id, 100, false)
  end

  test 'track_level_progress_sync does not call track_proficiency if old perfect score' do
    script_level = create :script_level
    student = create :student
    user_level = create :user_level, user_id: student.id, script_id: script_level.script_id, level_id: script_level.level_id, best_result: 100
  ...
  test 'track_level_progress_sync does not call track_proficiency if new passing score' do
    ...
    User.track_level_progress_sync(student.id, script_level.script_id, script_level.level_id, 20, false)
  end
