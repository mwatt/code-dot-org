...
#
# To use, include this in your serializer, and add provide attributes for :cols and :rows.
# Example:
# class MyDataTableSerializer < ::ActiveModel::Serializer
...
#   end
# end
module Api::V1::DataTableSerializerHelper
